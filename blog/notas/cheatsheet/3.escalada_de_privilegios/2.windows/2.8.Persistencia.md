...
> ⚠️ El binario debe estar preparado para correr como servicio — un exe de reverse shell normal puede fallar porque Windows espera que el proceso responda al SCM (Service Control Manager). Usa `msfvenom` con payload de servicio o un wrapper.
