...
Este link no llevara a [https://tickets.keeper.htb](https://tickets.keeper.htb) el cual debemos de agregar a nuestro archivo `/etc/hosts` para que pueda cargar el sitio web.
