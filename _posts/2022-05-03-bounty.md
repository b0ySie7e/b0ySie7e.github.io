...
layout: single
title: 
excerpt: "Maquina windows de nivel facil, la manera de intrusión es por medio de un archivo '.config'en la cual se inyectará comandos para tener accesos al servidor. Estio debido que tiene reglas definidas para evitar la subida de archivos php, asp, apsx. La escalada de privilegio se da a traves de patato exploit ya que el 'seImpersonatePrivilege' esta habilitado "
date: 2022-05-03
classes: wide
header:
  teaser: /assets/images/bounty/logoBounty.png
...
<img src="../assets/images/bounty/d099fd1a62b80cc183604b59cb033925.png" alt="d099fd1a62b80cc183604b59cb033925.png" width="596" height="159" class="jop-noMdConv">
...
```
<img src="../assets/images/bounty/93a862ea83640aeb7e00e9b962af4759.png" alt="93a862ea83640aeb7e00e9b962af4759.png" width="259" height="39" class="jop-noMdConv">

```bash
nmap -p80 -sCV -vvv -Pn 10.10.10.93 -oN servicesScan
```
<img src="../assets/images/bounty/2dfb4924b034cb6a2a8c91b6eb050ea0.png" alt="2dfb4924b034cb6a2a8c91b6eb050ea0.png" width="511" height="152" class="jop-noMdConv">

## Página web
Nos encontramos que el puerto 80 esta abierto, esto normalmente es "http" así que vamos a hechar un vistaso a la página web. 

<img src="../assets/images/bounty/4b4f45430846b91e981fefd9bdc317ed.png" alt="4b4f45430846b91e981fefd9bdc317ed.png" width="828" height="311" class="jop-noMdConv">
...
![51afc72e123423eb2e4bd358c3fae2e0.png](../assets/images/bounty/51afc72e123423eb2e4bd358c3fae2e0.png)

- whatweb

<img src="../assets/images/bounty/4fdad3012aedead9cb017bcc79effe81.png" alt="4fdad3012aedead9cb017bcc79effe81.png" width="1000" height="42" class="jop-noMdConv">
...
<img src="../assets/images/bounty/9d796acaa4659d89fd906844680e27d7.png" alt="9d796acaa4659d89fd906844680e27d7.png" width="611" height="216" class="jop-noMdConv">

Se encuentra dos directorios, pero no tenemos acceso de listar el contenido de estos.

<img src="../assets/images/bounty/7ab5d487f705c09376a04e512ee9e19c.png" alt="7ab5d487f705c09376a04e512ee9e19c.png" width="562" height="182" class="jop-noMdConv"> <img src="../assets/images/bounty/7a234dbec635e017112a0411cce97d23.png" alt="7a234dbec635e017112a0411cce97d23.png" width="567" height="137" class="jop-noMdConv">
...
<img src="../assets/images/bounty/357fec7e4d55daab0486d5cc5defa128.png" alt="357fec7e4d55daab0486d5cc5defa128.png" width="716" height="299" class="jop-noMdConv">

Tenemos un archivo "/transfer.aspx" el cual permitesubir un archivo.
subimos una imagen para ver que ocurre.
<img src="../assets/images/bounty/ea3fa8b33931684d86294a878d782725.png" alt="ea3fa8b33931684d86294a878d782725.png" width="716" height="275" class="jop-noMdConv">

Al parecer los archivo que se suben al servidor se almacenan en /uploadedfiles/

<img src="../assets/images/bounty/1e900a6c8ce162f9d9a316b3a7812d58.png" alt="1e900a6c8ce162f9d9a316b3a7812d58.png" width="950" height="504" class="jop-noMdConv">
...
![67332016d129f01805e2e1137def7300.png](../assets/images/bounty/67332016d129f01805e2e1137def7300.png)

El archivo no puede ser cargado al servidor, seguramente tiene alguna regla definida a nivel de codigo.

![9a5fd095ddefcadfb242c4102a8f10e6.png](../assets/images/bounty/9a5fd095ddefcadfb242c4102a8f10e6.png)
...
![ebdc767ef64d3672604cbdab68a14e9f.png](../assets/images/bounty/ebdc767ef64d3672604cbdab68a14e9f.png)
...
![b313d49cb6d0c0e8b597672ba9a96932.png](../assets/images/bounty/b313d49cb6d0c0e8b597672ba9a96932.png)
...
<img src="../assets/images/bounty/7e647b9beee819a8a5dfa13e68c7d6d5.png" alt="7e647b9beee819a8a5dfa13e68c7d6d5.png" width="2182" height="288" class="jop-noMdConv">
...
![a8a9cc783184225f47bacafe92e3e585.png](../assets/images/bounty/a8a9cc783184225f47bacafe92e3e585.png)

## Escalar privilegios - usuario merlin

Ganamos acceso al servidor y somos el usuario merlin

![33268bfa7b9182a2486f3fe7ac14e79a.png](../assets/images/bounty/33268bfa7b9182a2486f3fe7ac14e79a.png)

En el escritorio de merlin obtendremos nuestra flag.

![b26a8f9fc45d32966add336b5c3eb1ea.png](../assets/images/bounty/b26a8f9fc45d32966add336b5c3eb1ea.png)

Enumeramos el sistema y tenemos una posible via de escalar privilegios

![c67bcf6ea9371388af80ee2fdc568b3f.png](../assets/images/bounty/c67bcf6ea9371388af80ee2fdc568b3f.png)
...
![2170674f66c7dbc5f12ffd837d926847.png](../assets/images/bounty/2170674f66c7dbc5f12ffd837d926847.png)
...
```
**![233cff5f0416cdb6982c8af7e29f414c.png](../assets/images/bounty/233cff5f0416cdb6982c8af7e29f414c.png)**

Ya seriamos administradores wow:

**![dbcac5271c95c2e2555755f9f8cd9df7.png](../assets/images/bounty/dbcac5271c95c2e2555755f9f8cd9df7.png)**