...
excerpt: "Maquina de nivel media, creada por stuxnet. En la que se explotan vulnerabilidades como CVE-2020-35847, CVE-2020-35848
   en la versión de un Cockpit CMS 0.11.1  y CVE-2021-22204 que tiene la herramienta de exiftool en la que se aprovecha para realizar ejecución de comandos y poder ganar privilegios a nivel de usuario"
date: 2022-03-19
classes: wide
header:
  teaser: /assets/images/CMSpit/logo.png
...
![](/assets/images/CMSpit/search_exploit.png)
...
![](/assets/images/CMSpit/exploit_exec.png)
...
![](/assets/images/CMSpit/upload_file.png)

Vemos un boton para poder subir un archivo

![](/assets/images/CMSpit/upload_file02.png)
...
![](/assets/images/CMSpit/shell04.png)
...
![](/assets/images/CMSpit/shell05.png)
...
![](/assets/images/CMSpit/dbshell.png)
...
![](/assets/images/CMSpit/dbshell02.png)
...
![](/assets/images/CMSpit/stux01.png)
...
![](/assets/images/CMSpit/stux04.png)

**configfile**

![](/assets/images/CMSpit/stux05.png)
...
![](/assets/images/CMSpit/stux06.png)

La bash **no es SUID**

![](/assets/images/CMSpit/stux07.png)

Ejecutamos exiftool ccon nuestra imagen, y deberia de haber cambiado los permisos de la **/bin/bash**

![](/assets/images/CMSpit/stux08.png)

La **/bin/bash** ahora es SUID 

![](/assets/images/CMSpit/stux09.png)

## USER ROOT

![](/assets/images/CMSpit/root.png)
